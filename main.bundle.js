...
// Imports
exports.push([module.i, "@import url(https://fonts.googleapis.com/css?family=Hind+Siliguri:300,400,600&display=swap);", ""]);

// Module
exports.push([module.i, ".service-info {\n  display: inline-grid; }\n\n.tabs {\n  display: flex;\n  justify-content: space-around;\n  margin-top: 40px;\n  font-size: 3rem; }\n\n#bookings-ul {\n  grid-template-columns: auto auto; }\n\n.room-info {\n  display: inline-grid;\n  margin: 50px; }\n\nul {\n  display: grid;\n  display: inline-grid;\n  grid-template-columns: auto 50px;\n  margin-left: 40px;\n  width: 28%; }\n  ul li {\n    list-style: none;\n    margin: 5px; }\n  ul .remove-guest {\n    margin: 5px;\n    border-radius: 25px;\n    background: #422627;\n    border: none;\n    color: white; }\n  ul .remove-guest:hover {\n    background: white;\n    border: none;\n    color: #422627; }\n\n.daily-view {\n  font-size: 1em;\n  font-weight: 600;\n  display: flex;\n  justify-content: space-between; }\n\n.daily-stat {\n  text-transform: uppercase;\n  color: #f2f2f2;\n  margin: 5px; }\n\n.todays-date {\n  display: flex;\n  border: #422627 solid 2px;\n  flex-direction: column;\n  font-size: 1em;\n  font-weight: 600;\n  align-items: center;\n  justify-content: center; }\n\n.search-date {\n  display: inline-grid;\n  width: 100%;\n  justify-content: normal; }\n  .search-date #searchDate {\n    text-align: center;\n    font-size: 1em;\n    padding-left: 60px;\n    margin-bottom: 10px;\n    background: #f2f2f2; }\n  .search-date #selectedDate {\n    font-size: .75em;\n    padding: 5px;\n    border: none;\n    color: #f2f2f2;\n    background: #422627;\n    text-transform: lowercase; }\n    .search-date #selectedDate:hover {\n      background: black;\n      border: none;\n      color: #F0E5DD; }\n\n.search-border {\n  display: flex;\n  flex-direction: column;\n  align-items: center;\n  justify-content: center;\n  border: #422627 solid 2px;\n  padding: 10px; }\n\n.sg-specific {\n  display: inline-grid;\n  align-items: center;\n  text-align: center; }\n\n.guest-search {\n  text-align: center;\n  font-size: 1em;\n  margin-bottom: 20px;\n  background: #f2f2f2;\n  width: 100%; }\n\n#add-guest {\n  font-size: .75em;\n  padding: 5px;\n  border: none;\n  color: #f2f2f2;\n  background: #422627;\n  text-transform: lowercase;\n  width: 100%;\n  margin: 20px 0; }\n  #add-guest:hover {\n    background: black;\n    border: none;\n    color: #F0E5DD; }\n\n.selected-guest {\n  display: flex; }\n  .selected-guest .guest-btn-remove {\n    margin-left: 10px;\n    border-radius: 25px;\n    background: #422627;\n    border: none;\n    color: white;\n    width: 40px; }\n    .selected-guest .guest-btn-remove:hover {\n      background: white;\n      color: #422627;\n      border: none; }\n\n* {\n  box-sizing: border-box;\n  margin: 0;\n  padding: 0;\n  cursor: default;\n  font-weight: 400; }\n\naside {\n  background-color: #264241;\n  padding: 20px;\n  font-size: 1.5rem;\n  width: 40%; }\n  aside .daily-view {\n    margin: 20px 0; }\n  aside #currentDate {\n    color: #fff;\n    font-size: 1.5rem; }\n\nbody {\n  background-color: #F0E5DD;\n  display: flex; }\n\nmain {\n  width: 100%; }\n\nul:hover {\n  background: lightslategray;\n  color: white;\n  cursor: grab; }\n\nbutton:hover {\n  cursor: pointer; }\n", ""]);
...
/*!**********************!*\
  !*** ./src/Fetch.js ***!
  \**********************/
/*! exports provided: getGuests, getRooms, getBookings, getServices */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getGuests", function() { return getGuests; });
...
class Hotel {
  ...
  startHotel() {
    this.rooms = this.rooms.map(room => new _Room__WEBPACK_IMPORTED_MODULE_1__["default"](room));
    this.guests = this.guests.map(guest => new _Guest__WEBPACK_IMPORTED_MODULE_0__["default"](guest));
    this.bookings = this.bookings.map((booking, idx) => new _Booking__WEBPACK_IMPORTED_MODULE_2__["default"](booking, idx +1));
    this.services = this.services.map((service, idx)=> new _Service__WEBPACK_IMPORTED_MODULE_3__["default"](service, idx + 1)); 
  }
  
  addCustomer(name) {
    const newGuest = new _Guest__WEBPACK_IMPORTED_MODULE_0__["default"]({ id: this.guests.length + 1 , name  })
...
const domUpdates = {
  displayTodaysDate(today) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#currentDate').text(displayDate)
  }, 

  displayRoomsAvailable(roomsAvailable) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#roomsAvail').text(roomsAvailable)
  }, 

  displayTodaysRevenue(totalRev) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#revenueToday').text('$' + totalRev)
  }, 

  displayPercentageOfRoomsOccupied(occ) {
    // - Percentage of rooms occupied for today's date
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#occupancy').text(occ)

  },

  displayServices(services, control) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('#content').empty()
    services.forEach(service => {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('#content').append( ` 
  ...
  displayGuests(guests) {
    ...
    if (guests.length !== 0) {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('#content').append(` <p>Guest Not Found </p>`)
    }
  },
  ...
  displaySelectedGuest(guest) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.selected-guest').empty()
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.selected-guest').append(` <p>${guest.name} </p> <button class="guest-btn-remove">X</button> `)
  }
...
/* harmony import */ var _Fetch_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Fetch.js */ "./src/Fetch.js");
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()( document ).ready(async function () {
  let hotel = new _Hotel__WEBPACK_IMPORTED_MODULE_3__["default"](await Object(_Fetch_js__WEBPACK_IMPORTED_MODULE_5__["getGuests"])(), await Object(_Fetch_js__WEBPACK_IMPORTED_MODULE_5__["getRooms"])(), await Object(_Fetch_js__WEBPACK_IMPORTED_MODULE_5__["getBookings"])(), await Object(_Fetch_js__WEBPACK_IMPORTED_MODULE_5__["getServices"])())
  let control = new _Control__WEBPACK_IMPORTED_MODULE_4__["default"]();
  console.log(hotel)
  hotel.startHotel()
  hotel.changeDate(control.findDate());
  _domUpdates_js__WEBPACK_IMPORTED_MODULE_2__["default"].displayTodaysDate(hotel.selectedDate)
  _domUpdates_js__WEBPACK_IMPORTED_MODULE_2__["default"].displayRoomsAvailable(control.findRoomsAvailable(hotel.rooms, hotel.bookings, hotel.selectedDate).length);
  _domUpdates_js__WEBPACK_IMPORTED_MODULE_2__["default"].displayTodaysRevenue(control.totalRevenueForDate(hotel.rooms, hotel.services, hotel.bookings, hotel.selectedDate));
  _domUpdates_js__WEBPACK_IMPORTED_MODULE_2__["default"].displayPercentageOfRoomsOccupied(control.percentageOfRoomsOccupied(hotel.rooms, hotel.bookings, hotel.selectedDate));


  const $navBtn =jquery__WEBPACK_IMPORTED_MODULE_0___default()('.tab-btn');
  const $dateSubmit = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#selectedDate')
  const $addGuest = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#add-guest')

  const tabs = {
    services: () => _domUpdates_js__WEBPACK_IMPORTED_MODULE_2__["default"].displayServices(control.servicesByDate(hotel.services, hotel.selectedDate)),
    bookings: () => _domUpdates_js__WEBPACK_IMPORTED_MODULE_2__["default"].displayBookings(control.bookingsByDate(hotel.bookings, hotel.selectedDate)),
    guests: () => _domUpdates_js__WEBPACK_IMPORTED_MODULE_2__["default"].displayGuests(hotel.guests),
  }
  const guestTabs = {
    services: () => _domUpdates_js__WEBPACK_IMPORTED_MODULE_2__["default"].displayServices(control.servicesByID(hotel.services, hotel.selectedCustomer.id), control),
    bookings: () => _domUpdates_js__WEBPACK_IMPORTED_MODULE_2__["default"].displayBookings(control.checkDate(hotel), control.findRoomsAvailable(hotel.rooms, hotel.bookings, hotel.selectedDate)),
    guests: () => _domUpdates_js__WEBPACK_IMPORTED_MODULE_2__["default"].displayGuests(hotel.guests),
  }
  ...
  $dateSubmit.click((e) => {
    e.preventDefault()
    hotel.selectedDate = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#searchDate').val().replace(/-/g, "/");
    _domUpdates_js__WEBPACK_IMPORTED_MODULE_2__["default"].displayRoomsAvailable(control.findRoomsAvailable(hotel.rooms, hotel.bookings, hotel.selectedDate).length);
    _domUpdates_js__WEBPACK_IMPORTED_MODULE_2__["default"].displayTodaysRevenue(control.totalRevenueForDate(hotel.rooms, hotel.services, hotel.bookings, hotel.selectedDate));
    _domUpdates_js__WEBPACK_IMPORTED_MODULE_2__["default"].displayPercentageOfRoomsOccupied(control.percentageOfRoomsOccupied(hotel.rooms, hotel.bookings, hotel.selectedDate));
  })
  ...
  $addGuest.click((e)=>{
    _domUpdates_js__WEBPACK_IMPORTED_MODULE_2__["default"].displayCustomerForm() 
  })

  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.guest-search').keyup( (e) => {
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('.guest-search').val() === ""){
      tabs.guests()
    } else {
      _domUpdates_js__WEBPACK_IMPORTED_MODULE_2__["default"].displayGuests(control.guestsByName(hotel.guests, jquery__WEBPACK_IMPORTED_MODULE_0___default()('.guest-search').val()))
    }
  })

  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.selected-guest').click( (e) => {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.content').click(e => {
    e.preventDefault();
    if (e.target.classList.contains('guest-tab')) {
      hotel.selectedCustomer = control.getGuestByID(hotel.guests, parseInt(e.target.id))
      _domUpdates_js__WEBPACK_IMPORTED_MODULE_2__["default"].displaySelectedGuest(hotel.selectedCustomer)
    } else if (e.target.classList.contains('add-guest')) {
      const name = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#newGuest').val()
      hotel.addCustomer(name)
      _domUpdates_js__WEBPACK_IMPORTED_MODULE_2__["default"].displaySelectedGuest(hotel.selectedCustomer)
    } else if (e.target.classList.contains('remove-guest')) {
      hotel.removeCustomer(parseInt(e.target.id))
      _domUpdates_js__WEBPACK_IMPORTED_MODULE_2__["default"].displayGuests(control.guestsByName(hotel.guests, jquery__WEBPACK_IMPORTED_MODULE_0___default()('.guest-search').val()))
    } else if (e.target.classList.contains('update-service-btn') && jquery__WEBPACK_IMPORTED_MODULE_0___default()(`.update-service-input-${e.target.id}`).val()) {
      const service = control.findService(hotel.services, parseInt(e.target.id))
      service.updateFoodItem(jquery__WEBPACK_IMPORTED_MODULE_0___default()(`.update-service-input-${e.target.id}`).val());
